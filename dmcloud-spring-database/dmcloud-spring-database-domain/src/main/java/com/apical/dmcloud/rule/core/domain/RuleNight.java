...
public class RuleNight extends Rule
{
	...
	{
		String jpql = "select 1 from RuleNight _rule where _rule.name=:name";
	...
	{
		String jpql = "delete from RuleNight _rule where _rule.id=:id";
	...
	public static boolean assignToVehicle(long ruleId, long vehicleId) throws RuleAssignmentException
	{
		...
		if(count == 1)
		{
			MiddleEntryCacheService.removeRuleAssigned2Vehicle(RuleNight.class, vehicleId);
	...
	public static boolean unAssignToVehicle(long ruleId, long vehicleId) throws RuleAssignmentException
	{
		...
		String sql = "delete from cl_rule_night_vehicle_map where RULE_ID =:ruleId and VEHICLE_ID =:vehicleId";
		int count = getRepository().createSqlQuery(sql)
				.addParameter("ruleId", ruleId)
				.addParameter("vehicleId", vehicleId)
				.executeUpdate();
	...
	public static RuleNight getByVehicleId(long vehicleId)
	{
		...
		List<RuleNight> rules = getRepository().createSqlQuery(sql)
				.addParameter("vehicleId", vehicleId)
	...
	public static  List<Long> queryVehicleIds(long ruleId){
		String sql = "select VEHICLE_ID from cl_rule_night_vehicle_map where RULE_ID =:ruleId";
	...
	public static long countAllVechilesById(long ruleId){
		String sql = "select count(VEHICLE_ID) from cl_rule_night_vehicle_map where RULE_ID =:ruleId";
	...
	public static  List<Long> queryVehicleIds(long ruleId,long companyId){
		...
		return Rule.queryVehicleIds("cl_rule_night_vehicle_map", ruleId, companyId);
	}
	...
	public static long countAllVechilesById(long ruleId,long companyId){
		...
		return Rule.countAllVechilesById("cl_rule_night_vehicle_map", ruleId, companyId);
	}
	...
	public static List<Long> queryAssignedVehicleIdsInPage(long ruleId,int pageCount , int pageSize,long companyId){
		...
		return Rule.queryAssignedVehicleIdsInPage("cl_rule_night_vehicle_map", ruleId, pageCount, pageSize, companyId);
	}
