...
public class DeviceUploadBreakpoint extends KoalaAbstractEntity
{
	/**
	...
	{
		String jpql = "delete from DeviceUploadBreakpoint _record where _record.id=:id";
	...
	{
		String jpql = "delete from DeviceUploadBreakpoint _point where _point.deviceId=:productId and _point.serverFilePath=:filepath";
		int count = getRepository().createJpqlQuery(jpql.toString())
	...
	{
		String jpql = "select count(_point.id) from DeviceUploadBreakpoint _point where _point.deviceId=:deviceId and _point.serverFilePath=:serverFilePath";
	...
	{
		String jpql = "update DeviceUploadBreakpoint _point set"
	...
	{
		String jpql = "delete from DeviceUploadBreakpoint _point where _point.deviceId=:deviceId";
		int count = getRepository().createJpqlQuery(jpql.toString())
				.addParameter("deviceId", deviceId)
				.executeUpdate();
		if(count > 0)
	...
	{
		String jpql = "select _point from DeviceUploadBreakpoint _point where _point.deviceId=:deviceId and _point.serverFilePath=:filepath order by _record.breakpointTime desc";
	...
	{
		String jpql = "select count(_record.id) from DeviceUploadBreakpoint _point where _point.deviceId=:deviceId";
	...
	{
		String jpql = "select _record from DeviceUploadBreakpoint _point where _point.deviceId=:deviceId";
