...
/**
 * 权限资源,它是{@link MenuResource}、{@link PageElementResource}、{@link UrlAccessResource}共同的基类。
...
public abstract class SecurityResource extends SecurityAbstractEntity {
    ...
    public SecurityResource findByName(String name) {
    	String query = "SELECT _securityResource  FROM SecurityResource _securityResource WHERE"
    			+ " TYPE(_securityResource) = :securityResourceType AND _securityResource.name = :name";
