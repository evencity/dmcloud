...
import com.apical.dmcloud.alarm.middle.core.AlarmRecordNotExistException;
 ...
 *
 */
@Entity(name = "Middle.DeviceAlarmRecord")
...
public class DeviceAlarmRecord extends AbstractIDEntity
{
	...
	{
		String jpql = "delete from Middle.DeviceAlarmRecord _record"
				+ " where _record.id=:id";
	...
	public static long queryIdByDeviceIdAndAlarmUId(long deviceId, String alarmUId)
			throws AlarmRecordNotExistException
	{
		String jpql = "select _record.id from Middle.DeviceAlarmRecord _record"
	...
	{
		String jpql = "select _record from Middle.DeviceAlarmRecord _record"
				+ " where _record.deviceId=:deviceId"
				+ " and _record.alarmUId=:alarmUId";
	...
	{
		String jpql = "select count(_record.id) from Middle.DeviceAlarmRecord _record"
