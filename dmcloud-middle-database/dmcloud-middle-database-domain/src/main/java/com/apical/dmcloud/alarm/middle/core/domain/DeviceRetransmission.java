 ...
 *
 */
@Entity(name = "Middle.DeviceRetransmission")
...
public class DeviceRetransmission extends AbstractIDEntity
{
	...
	{
		String jpql = "delete from Middle.DeviceRetransmission _record where _record.id=:id";
	...
	{
		String jpql = "delete from Middle.DeviceRetransmission _point where _point.deviceId=:deviceId";
		int count = getRepository().createJpqlQuery(jpql.toString())
	...
	{
		String jpql = "select count(_record.id) from Middle.DeviceRetransmission _point where _point.deviceId=:deviceId";
